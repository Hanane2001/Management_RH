            ...
            <form method="POST" action="{{ route('departments.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-input @error('name') is-invalid @enderror" 
                           name="name" value="{{ old('name') }}" placeholder="e.g., Human Resources" required>
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-textarea @error('description') is-invalid @enderror" 
                              name="description" rows="3" placeholder="Enter department description...">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
