                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input @error('position') is-invalid @enderror" 
                               name="position" value="{{ old('position', $contract->position) }}" required>
                        @error('position')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" class="form-input @error('base_salary') is-invalid @enderror" 
                               name="base_salary" value="{{ old('base_salary', $contract->base_salary) }}" required>
                        @error('base_salary')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-input @error('end_date') is-invalid @enderror" 
                               name="end_date" value="{{ old('end_date', $contract->end_date ? $contract->end_date->format('Y-m-d') : '') }}">
                        @error('end_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" class="form-input @error('bonus') is-invalid @enderror" 
                               name="bonus" value="{{ old('bonus', $contract->bonus) }}">
                        @error('bonus')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
