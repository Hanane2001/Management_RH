            ...
            <form method="POST" action="{{ route('notifications.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-input @error('title') is-invalid @enderror" 
                           name="title" value="{{ old('title') }}" placeholder="Notification title" required>
                    @error('title')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-textarea @error('message') is-invalid @enderror" 
                              name="message" rows="5" placeholder="Write your notification message here..." required>{{ old('message') }}</textarea>
                    @error('message')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-select @error('type') is-invalid @enderror" name="type" required>
                        <option value="internal" {{ old('type') == 'internal' ? 'selected' : '' }}>Internal (System)</option>
