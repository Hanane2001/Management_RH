            ...
            <form method="POST" action="{{ route('documents.update', $document) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="current-file">
                        ...
                        <span style="float: right;">{{ $document->getFileSizeFormatted() }}</span>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <span class="form-hint">Leave empty to keep current file. Allowed: PDF, DOC, DOCX, JPG, PNG (max 10MB)</span>
                    @error('document')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
